      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <div className="text-2xl font-bold mt-2">{products.filter(p => p.isActive).length}</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            <div className="text-sm text-gray-600">Total Stock</div>
            <div className="text-2xl font-bold mt-2">{products.reduce((sum, p) => sum + p.currentStock, 0)}</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
